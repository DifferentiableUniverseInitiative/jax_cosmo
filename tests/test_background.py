...
def test_distances_flat():
    ...
    cosmo_jax, chi_jax = bkgrd.radial_comoving_distance(cosmo_jax, a)
    chi_jax = chi_jax / cosmo_jax.h
    assert_allclose(chi_ccl, chi_jax, rtol=0.5e-2)

    chi_ccl = ccl.comoving_angular_distance(cosmo_ccl, a)
    cosmo_jax, chi_jax = bkgrd.transverse_comoving_distance(cosmo_jax, a)
    chi_jax = chi_jax / cosmo_jax.h
    assert_allclose(chi_ccl, chi_jax, rtol=0.5e-2)

    chi_ccl = ccl.angular_diameter_distance(cosmo_ccl, a)
    cosmo_jax, chi_jax = bkgrd.angular_diameter_distance(cosmo_jax, a)
    chi_jax = chi_jax / cosmo_jax.h
    assert_allclose(chi_ccl, chi_jax, rtol=0.5e-2)
...
def test_growth():
    ...
    cosmo_jax, gjax = bkgrd.growth_factor(cosmo_jax, a)
...
def test_growth_rate():
    ...
    cosmo_jax, fjax = bkgrd.growth_rate(cosmo_jax, a)
